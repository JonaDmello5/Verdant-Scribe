      ...
      <main className="flex-grow">
        <section className="container mx-auto max-w-5xl px-4 py-20 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-10 max-w-3xl mx-auto">
            A digital sanctuary where your thoughts can grow. Verdant Scribe is a new kind of journaling app that turns your words into a beautiful, ever-evolving digital garden.
          </p>
          ...
          <div className="container mx-auto max-w-5xl px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-4">
                In your private garden, each note you write becomes a unique plant. Watch your ideas take root and flourish as you write. The more you nurture your thoughts, the more vibrant your garden becomes.
              </p>
